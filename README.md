...
- تقوية V5: لا CERTIFIED أو SAFE دون قياس توقيت مرجعي حقيقي مرتبط بالبصمة؛ أسماء الإصدار والإجماع قرائن لا إثبات.
- استمرار البحث المحدود عند ظهور ترجمة من نفس عائلة الفيديو بلا قياس، وعدم اعتماد النتائج الاحتياطية بوصفها متزامنة.
- تحذير واضح من عدم إثبات التوقيت وفصل توفر الترجمة عن ثبوت توقيتها في التقييم.
- تثبيت حالات البلوراي الثلاث للبلاغ #82 دون ادعاء حل تزامنها أو إغلاق البلاغ.

## ما الجديد في 5.2.1

- بحث أدق باسم الملف عبر SubDL v2 مع البحث القديم كاحتياط، دون ادعاء تحقق التزامن.
- إخفاء معرّفات النتائج الحساسة من سجلات V5.
- تصحيح رقم إصدار الإضافة مع الحفاظ على معرّف التثبيت.
- مشكلة توافق توقيت نسخ BluRay في البلاغ #82 ما زالت مفتوحة.

## ما الجديد في 5.2.0

- إصلاح فقدان نتائج SubDL الناجحة عند فشل صيغة بحث لاحقة، واستخدام عنوان العمل بدل معرّفه في البحث النصي.
- الاحتفاظ بهوية العمل التي يعيدها SubDL عند استخراج ملفات الحلقات من حزمة الموسم.
- إعادة البحث بالبصمة دون شرط الحجم إذا لم توجد مطابقة؛ بعض تدفقات Stremio ترسل حجم المجموعة بدل الملف.
- استمرار الفحص والبحث عن عائلة نسخة الفيديو عندما تكون الترجمات العربية المتاحة من مصدر مختلف. البحث الإضافي محدود زمنيًا وتُخزن نتائجه المكتملة مؤقتًا.
- إظهار اسم إصدار الترجمة لتمييز نسخ المدد والإصدارات المختلفة في قائمة Stremio.
- لا يثبت حجم الملف أو دقته تطابق التوقيت. إذا لم توجد ترجمة متوافقة، تبقى الخيارات الاحتياطية موسومة بتوقيت غير مؤكد.

## ما الجديد في 5.1.8

- إصلاح بحث شامل لاختلاف سنة الفهرسة بين IMDb ومزود الترجمة؛ لا تُدمج السنة مع IMDb/TMDb لأنها قيد زائد على هوية مؤكدة أصلًا.
- إبقاء السنة في بحث العنوان الدقيق، ثم حذفها تلقائيًا في Deep Recovery إذا أعاد البحث الدقيق صفرًا.
- استمرار تمرير النتائج المستعادة عبر بوابات هوية العمل واللغة والتسليم وسلامة الملف قبل إظهارها.
