...
- تثبيت النقاط وعلامات الاستفهام والتعجب والفواصل في جهة الجملة العربية الصحيحة.
- تثبيت الأقواس المدوّرة والمربعة والمعقوفة وعلامات الاقتباس العربية من الجهتين.
- استخدام مرساتي RTL مع عزل Unicode لكل سطر عربي بدل الاعتماد على آخر محرف فقط.
- إعادة معالجة ملف SRT عند الإرسال، لذلك يشمل الإصلاح النتائج القديمة الموجودة في الكاش.
- إبقاء الأسطر الرقمية والأسطر الإنجليزية الغالبة دون تعديل.
...
```json
{"status":"ok","version":"3.5.1","ai":false}
```
