# m7md Arabic Resolver v3.1.2

إضافة Stremio خاصة للترجمات العربية. الإصدار v3.1.2 يستعيد نتائج المزوّدين الحية وروابط التنزيل الفعلية، ويطابق **نسخة ملف الفيديو نفسها** قبل أن يرتب النتائج، ويفك حزم الترجمات بأمان، ويعمل بدون أي ذكاء اصطناعي.
