# m7md Arabic Resolver v3.1

إضافة Stremio خاصة للترجمات العربية. الإصدار v3.1 يطابق **نسخة ملف الفيديو نفسها** قبل أن يرتب النتائج، ويفك حزم الترجمات بأمان، ويعمل بدون أي ذكاء اصطناعي.
...
- فك تلقائي محدود الموارد لصيغ ZIP وGZIP وXZ، مع اختيار أفضل ملف ترجمة عربية داخل ZIP.
